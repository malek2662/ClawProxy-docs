...
const STEPS = [
    {
        ...
        link: { to: '/docs/monitoring', label: 'Explore monitoring' },
    ...
    },
    {
        ...
        link: { to: '/docs/monitoring#view-and-filter-logs', label: 'Explore request logs' },
    ...
    },
    {
        ...
        link: { to: '/docs/monitoring#monitor-events-with-notifications', label: 'Learn about notifications' },
